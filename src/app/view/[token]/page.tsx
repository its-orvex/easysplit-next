  ...
  if (status === 'not-configured') {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        ...
        <Link href="/" className="mt-4 block text-teal-600 text-sm underline">Back to home</Link>
      </div>
    )
  }
  ...
  if (status === 'not-found' || !trip) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        ...
        <Link href="/" className="text-teal-600 text-sm underline">Back to home</Link>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="bg-amber-50 border border-amber-200 text-amber-800 text-sm rounded-xl px-4 py-3 mb-6 flex items-center justify-between gap-3">
        ...
        <Link href="/" className="text-teal-600 font-semibold text-xs whitespace-nowrap hover:underline">Sign in</Link>
      </div>
