...
export default function AddExpensePage() {
  ...
  if (!trip) return (
    <div className="max-w-lg mx-auto px-4 py-10">
      ...
      <Link href="/" className="text-teal-600 underline text-sm mt-2 block">Back to home</Link>
    </div>
  )
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-10">
      <Link href={`/trip/${id}`} className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-gray-800 mb-6">
