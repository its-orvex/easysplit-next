    ...
    <div>
      ...
      {trip.expenses.length === 0 ? (
        <div className="text-center py-16">
          ...
          <Link href={`/trip/${trip.id}/add-expense`}
...
export default function TripDetailPage() {
  ...
  if (!trip) return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <Link href="/" className="text-teal-600 underline mt-2 block text-sm">Back to home</Link>
    </div>
  )
  ...
  function handleEditExpense(expense: any) {
    router.push(`/trip/${id}/add-expense?edit=${expense.id}`)
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <Link href="/" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-gray-800 mb-6">
